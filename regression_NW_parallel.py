...
def regression_analysis(dirFile):
...
# Here we will use all available CPU cores in parallel:
# With using pandas or R datatables and parallel processing this is
# in total now ca. 20 times faster!

if __name__ == '__main__':
    cpus = os.cpu_count() - 2
    with Pool(processes=cpus) as p:
        print(p.map(regression_analysis, rawFiles))
