...
if __name__ == '__main__':
    ...
    # file_path = uf.select_file([('Recording Files', 'raw.txt')])
    # linear_regression_scoring(file_path)
    ...
    for r_name in rec_list:
        linear_regression_scoring(f'{base_dir}/{r_name}/{r_name}_raw.txt')
